 ...
 */
final class Version20250605231613 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create initial database schema for news portal with categories, news, comments and junction tables';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE news (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, short_description CLOB NOT NULL, content CLOB NOT NULL, insert_date DATETIME NOT NULL, picture VARCHAR(255) DEFAULT NULL, view_count INTEGER DEFAULT 0 NOT NULL, published BOOLEAN DEFAULT 0 NOT NULL)
        SQL);
        $this->addSql(<<<'SQL'
